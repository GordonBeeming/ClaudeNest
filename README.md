...
- [Local Development Guide](docs/local-development.md) — Setup, Auth0, Stripe, database access
- [Architecture](docs/architecture.md) — System overview, infrastructure, deployment
