...
namespace ClaudeNest.Backend.Migrations
{
    ...
    [Migration("20260306144808_AllowReusedDeactivatedCouponCodes")]
    partial class AllowReusedDeactivatedCouponCodes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClaudeNest.Backend.Data.Entities.UserFolderPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("UserId", "AgentId", "Path")
                        .IsUnique();

                    b.ToTable("UserFolderPreferences");
                });
