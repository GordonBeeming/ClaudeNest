...
function Auth0SignOutButton({ onClose }: { onClose: () => void }) {
  ...
  return (
    <button
      ...
      className="flex w-full items-center gap-2.5 px-4 py-2 text-sm text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20 min-h-[44px]"
    >
...
function Auth0HeaderSignOut() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 rounded-lg px-3 py-2 sm:px-2 sm:py-1 text-sm text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20 transition-colors"
    >
      <LogOut className="h-4 w-4" />
...
function UserMenu() {
  ...
  return (
    <div ref={menuRef} className="relative">
      <button
        onClick={() => setOpen((o) => !o)}
        className="flex items-center gap-2 rounded-lg px-2 py-2 sm:py-1 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800 transition-colors"
      >
      ...
      {open && (
        <div className="absolute right-0 mt-1 w-56 rounded-lg border border-gray-200 bg-white py-1 shadow-lg dark:border-gray-700 dark:bg-gray-900 z-50">
          ...
          <button
            ...
            className="flex w-full items-center gap-2.5 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-800 min-h-[44px]"
          >
